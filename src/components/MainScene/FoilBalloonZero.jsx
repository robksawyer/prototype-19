...
export default function FoilBalloonZero(props) {
  const [colorMap, displacementMap, normalMap, roughnessMap] = useLoader(
    TextureLoader,
    [
      '/3d/AdobeStock_416787728/foil_balloon_zero/plastic_Mat_baseColor.png',
      '/3d/AdobeStock_416787728/foil_balloon_zero/plastic_Mat_roughness.png',
      '/3d/AdobeStock_416787728/foil_balloon_zero/plastic_Mat_normal.png',
      '/3d/AdobeStock_416787728/foil_balloon_zero/plastic_Mat_metallic.png',
    ],
  );
